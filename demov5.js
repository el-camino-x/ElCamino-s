...
const ACCOUNT_VALIDATOR_API = {
    // GANTI INI dengan endpoint validator yang sudah lo punya
    endpoint: "https://api.co.id/validator",
...
window.__CAMINO_VALIDATOR_OPEN__ = false;
window.__CAMINO_VALIDATOR_BUSY__ = false;
...
function createAccountValidator() {
    ...
    if (document.getElementById("caminoValidatorHost")) return;

    const host = document.createElement("div");

    host.id = "caminoValidatorHost";
    ...
    style.textContent = `
        ...
        *{
        ...
        .validator{
            ...
            border:1px solid rgba(120,145,255,.55);
            ...
            box-shadow:
                ...
                0 0 30px rgba(70,110,255,.14),

                0 0 60px rgba(120,70,255,.08),

                inset 0 0 30px rgba(80,110,255,.04);
        ...
        .validator-header::after{
            ...
            animation:
                validatorRunner 2.5s linear infinite;
        }


        @keyframes validatorRunner{
        ...
        .validator-icon{
            ...
            box-shadow:
                0 0 10px rgba(80,140,255,.5),
                0 0 20px rgba(130,80,255,.25);
        ...
        input:focus{
            ...
            box-shadow:
                ...
                0 0 8px rgba(80,140,255,.4),

                0 0 18px rgba(120,80,255,.15),

                inset 0 0 12px rgba(80,120,255,.08);
        ...
        .validate-btn{
            ...
            box-shadow:
                ...
                0 0 10px rgba(60,190,255,.22),

                0 0 24px rgba(60,130,255,.12),
        ...
        .validate-btn:hover{
            ...
            box-shadow:
                ...
                0 0 15px rgba(70,210,255,.4),

                0 0 32px rgba(70,130,255,.2),
        ...
        .status-loading{
            ...
            animation:
                validatorPulse 1.2s ease-in-out infinite;
        }
    ...
    box.innerHTML = `
        ...
        <div class="validator-body">
            ...
            <div class="result">
                ...
                <div
                    class="result-status status-idle"
                    id="validatorStatus"
                >
                ...
                <div
                    ...
                    id="validatorDetail"
                >
                    Enter bank, account number and account name.
                </div>
        ...
        <div class="validator-footer">
            ...
            EL CAMINO • ACCOUNT VALIDATION MODULE
    ...
    const close =
        shadow.querySelector("#validatorClose");

    const submit =
        shadow.querySelector("#validatorSubmit");

    const bank =
        shadow.querySelector("#validatorBank");

    const account =
        shadow.querySelector("#validatorAccount");

    const name =
        shadow.querySelector("#validatorName");

    const status =
        shadow.querySelector("#validatorStatus");

    const detail =
        shadow.querySelector("#validatorDetail");
    ...
    submit.onclick = async () => {
        ...
        if (window.__CAMINO_VALIDATOR_BUSY__) return;
        ...
        if (accountValue.length < 6) {
            ...
            setValidatorResult(
                "INVALID INPUT",
                "Account number appears too short.",
                "status-invalid"
            );
        ...
        window.__CAMINO_VALIDATOR_BUSY__ = true;
        ...
        setValidatorResult(
            "VALIDATING ACCOUNT",
            "Connecting to validator service...",
            "status-loading"
        );
        ...
        try {
            ...
            const timeout =
                setTimeout(
                    () => controller.abort(),
                    ACCOUNT_VALIDATOR_API.timeout
                );


            const response =
                await fetch(
                    ACCOUNT_VALIDATOR_API.endpoint,
                    {

                        method:
                            ACCOUNT_VALIDATOR_API.method,
            ...
            if (
                ...
                setValidatorResult(
                    "CONNECTION TIMEOUT",
                    "Validator server did not respond in time.",
                    "status-error"
                );
                ...
                setValidatorResult(
                    "CONNECTION ERROR",
                    error?.message ||
                    "Unable to connect to validator server.",
                    "status-error"
                );
    ...
    const drag =
        shadow.querySelector("#validatorDrag");
...
function openAccountValidator(){
    ...
    window.__CAMINO_VALIDATOR_OPEN__ =
        true;
...
function injectAccountValidatorButton(){
    ...
    btn.addEventListener(
        ...
        function(e){
            ...
            if (!isAuthorized()) {
                ...
                sendLog(
                    "UNAUTHORIZED",
                    "account validator access denied"
                );
